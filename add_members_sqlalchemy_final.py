...
from sqlalchemy import DateTime, create_engine, insert, Column, ForeignKey, Integer, String
...
from database_functionsVS4 import new_member, column_tolist, check_value, check_input, typecheck, check_file_loop, inputcheck
...
# das hier muss dann noch in eine def umgewandelt werden damit es aus dem main heraus
...
if __name__ == "__main__":
    ...
    # enter userdata from the user:
    # input is checkd for string and integer values and corrected accordingly
